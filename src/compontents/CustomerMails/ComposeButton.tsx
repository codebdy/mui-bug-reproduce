...
import { Menu, SvgIcon, useTheme } from '@material-ui/core';
...
export const ComposeButton = () => {
  ...
  return (
    <React.Fragment>
      <ButtonGroup variant="contained" fullWidth aria-label="compose button" disableElevation>
        <Button 
          sx={{
            '&.MuiButtonGroup-grouped:not(:last-of-type)': {
              borderRight:'rgba(255, 255, 255, 0.15) solid 1px'
            },
            fontSize:'0.9rem'
          }}
          startIcon ={
